...
public class HelpGUI extends JFrame {
    ...
    public static final String description = "How To Use The Program: " 
            + "\n"
            + "When the program starts you "
            + "will select whether or not the search will contain the "
            + "customer's full name " 
            + "\n" 
            + "or if it starts if a certain letter. "
            + "Then type in their name and click on search. "
            + "the corresponding reservations "
            + "\n"
            + "will then show up in order.";
    /**
